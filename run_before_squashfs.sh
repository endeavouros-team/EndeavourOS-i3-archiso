...
git clone https://github.com/endeavouros-team/i3-live-user-settings.git
cd i3-live-user-settings
rm /home/liveuser/.config/i3/config /home/liveuser/.config/i3/i3blocks.conf
cp config /home/liveuser/.config/i3/config
cp i3blocks.conf /home/liveuser/.config/i3/i3blocks.conf
cp LICENSE /home/liveuser/
chown -R liveuser:users /home/liveuser/.config
cd .. 
rm -R i3-live-user-settings
